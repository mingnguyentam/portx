...
namespace PortX.EntityFrameworkCore.Domains.TransportationSetItems
{
    public class TransportationSetItemRepositoryTests : PortXEntityFrameworkCoreTestBase
    {
        private readonly ITransportationSetItemRepository _transportationSetItemRepository;

        public TransportationSetItemRepositoryTests()
        {
            _transportationSetItemRepository = GetRequiredService<ITransportationSetItemRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            {
                // Act
                var result = await _transportationSetItemRepository.GetListAsync(
                ...
                result.First().Id.ShouldBe(Guid.Parse("a7ccd494-7e51-42d7-95fc-47fb429d6c01"));
            });
        }
        ...
        public async Task GetCountAsync()
        {
            ...
            {
                // Act
                var result = await _transportationSetItemRepository.GetCountAsync(
