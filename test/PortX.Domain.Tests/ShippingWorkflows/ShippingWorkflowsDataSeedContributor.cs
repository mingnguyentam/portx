...
{
    public class ShippingWorkflowsDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        private bool IsSeeded = false;
        private readonly IShippingWorkflowRepository _shippingWorkflowRepository;
        private readonly IUnitOfWorkManager _unitOfWorkManager;

        public ShippingWorkflowsDataSeedContributor(IShippingWorkflowRepository shippingWorkflowRepository, IUnitOfWorkManager unitOfWorkManager)
        {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            await _shippingWorkflowRepository.InsertAsync(new ShippingWorkflow
            (
                id: Guid.Parse("fbfc4ed2-03e8-4c17-8f07-6b9dbc85ba19"),
            ...
            await _shippingWorkflowRepository.InsertAsync(new ShippingWorkflow
            (
                id: Guid.Parse("51ac27c3-bd04-4161-83cb-cb78c5a6c46d"),
